...
function bookbeat_stage_func($atts){
    ...
    //    Table sorter code
//    $content = "	<head><link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2.26.0/css/theme.metro-dark.min.css'>
...
//			{
//				$('#booklist').tablesorter({theme: 'metro-dark', widgets: ['zebra']});
//			}
//			);
//		</script></head>";
    ...
    // Table form
    $content = $content . "<div>";
    $content = $content .  "<TABLE id='booklist' class='tablesorter'><THEAD><TR><TH>Title</TH><TH>Author</TH><TH>Sales Rank</TH><TH>Num Reviews</TH><TH>Avg Rating</TH></TR></THEAD><TBODY>";
